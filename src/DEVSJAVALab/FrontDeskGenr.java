...
public class FrontDeskGenr extends ViewableAtomic{
  ...
  public FrontDeskGenr() {this("carGenr", 7);}

public FrontDeskGenr(String name,double period){
   super(name);
   addInport("in");
   addOutport("out");
...
//   content con = makeContent("out", new entity("car" + count));
   content con = makeContent("out", new vehicleEntity("Patient" + count, 5+r.uniform(20), 50+r.uniform(100), 1));
   m.add(con);
