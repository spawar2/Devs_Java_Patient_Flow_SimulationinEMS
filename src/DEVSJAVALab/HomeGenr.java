...
public class HomeGenr extends ViewableAtomic{
  ...
  public HomeGenr() {this("carGenr", 7);}

public HomeGenr(String name,double period){
   super(name);
   addInport("in");
   addOutport("out");
...
//   content con = makeContent("out", new entity("car" + count));
   content con = makeContent("out", new vehicleEntity("Ambulance" + count, 5+r.uniform(20), 50+r.uniform(100), 1));
   m.add(con);
